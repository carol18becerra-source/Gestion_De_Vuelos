...
public class App {
	public static void main(String[] args) {
		...
		//Ejercicio preliminar de destinos diferentes
		
		System.out.println("-------------------------------");
		System.out.println("EJERCICIO PRELIMINAR");
		System.out.println("-------------------------------");
		
		Vuelo masPasajeros = null;

		for (Vuelo v : listaVuelos) {
		    if (masPasajeros == null || v.getPasajeros().size() > masPasajeros.getPasajeros().size()) {
		        masPasajeros = v;
		    }
		}

		if (masPasajeros != null) {
		    System.out.println("El vuelo con más pasajeros es hacia: " + masPasajeros.getDestino());
		}
